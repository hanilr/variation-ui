...
int main() {
    ...
    vn_line('X', "vertical", vnt_red, vnw_first);
    vn_line('O', "vertical", vnt_green, vnw_second);
    vn_line('I', "vertical", vnt_blue, vnw_third);

    vn_line('U', "horizontal", vnt_red, vnw_first);
    vn_line('-', "horizontal", vnt_green, vnw_second);
    vn_line('+', "horizontal", vnt_blue, vnw_third);
    /* ------------- */
